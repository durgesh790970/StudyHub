...
def get_db():
    """Get or initialize database functions from db.py module"""
    global db
    ...
    try:
        ...
        db_module_path = project_root / 'database' / 'db.py'
        
        spec = importlib.util.spec_from_file_location("database_module", db_module_path)
        module = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(module)
        
        # Use the module itself as db (it has all the functions like get_connection, add_student, etc.)
        db = module
        return db
...
def api_register_user(request):
    ...
    try:
        # Create user using Django User model
        ...
        if user:
            # Import and create user profile
            ...
            UserActivity.objects.create(
                ...
                data={'resource_type': 'Auth', 'status_code': 201}
            )
...
def api_login_user(request):
    ...
    try:
        ...
        try:
            auth_user = DjangoUser.objects.get(email=email)
        ...
        if not check_password(password, auth_user.password):
            ...
            UserActivity.objects.create(
                ...
                data={'resource_type': 'Auth', 'status_code': 401}
            )
        ...
        UserActivity.objects.create(
            ...
            data={'resource_type': 'Auth', 'status_code': 200}
        )
            ...
            if success:
                ...
                try:
                    ...
                    UserActivity.objects.create(
                        ...
                        data={'resource_type': 'Profile', 'status_code': 200}
                    )
                except DjangoUser.DoesNotExist:
                    pass
            ...
            if success:
                ...
                try:
                    ...
                    UserActivity.objects.create(
                        ...
                        description=f"Purchased {data.get('item_type', 'item')} for ₹{data['amount']}",
                        data={'resource_type': 'Payment', 'status_code': 201}
                    )
                except DjangoUser.DoesNotExist:
                    pass
            ...
            if success:
                ...
                try:
                    ...
                    UserActivity.objects.create(
                        ...
                        description=f"Completed {data['test_name']} - Score: {data.get('score_percent', 0)}%",
                        data={'resource_type': 'Test', 'status_code': 201}
                    )
                except DjangoUser.DoesNotExist:
                    pass
